...
def _ranking_fast(
    ...
    norm_context_only_hidden = context_only_hidden / context_hidden.norm(dim=2, keepdim=True)
    ...
    topk_image_sim, _ = torch.topk(cosine_matrix_image, k=1, dim=1, largest=True)
