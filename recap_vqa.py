...
def recaptioning(things_coco_dataloader_train, coco_dataloader_val, coco_cider_dataloader, ref_caps, model_captioning, model_downstream, optimizer1, optimizer2, weights):
    ...
    loss_fn = torch.nn.CrossEntropyLoss(reduction='none')
    model_captioning_state_dict = torch.load('/workspace/T5_pod/T5_checkpoint_peak_5e8.pth', map_location='cpu')
...
################################################################################
                        ...
                        if it%250==0:
                                torch.save(model_captioning.state_dict(), './T5_checkpoint2_5e8.pth')
                        ...
                        wandb.log({"step": logging_step})
                            ...
                            # torch.save(model_captioning.state_dict(), './T5_checkpoint2.pth')
                            print(f)
