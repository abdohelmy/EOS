...
class Coco_Dataset_VQA(Dataset):
    def __init__(self, img_root=None, ann_root=None, split="train", downstream=True):
       ...
       if split == "train":
            ...
            #  self.down = self.down.sample(n=50000)
             ...
             self.down = pd.read_json(self.down_root)
            #  self.down = self.down.sample(n=100,  random_state=42)
    ...
    def __getitem__(self, i):
        ...
        return label,caption, ques, answer, image, img_id
...
class FineCapEval(Dataset):
    ...
    #    self.processor = AutoProcessor.from_pretrained("Salesforce/blip2-opt-2.7b")
       self.processor = AutoProcessor.from_pretrained("Salesforce/blip2-opt-2.7b-coco")
       self.hf = h5py.File(self.img_root, 'r')
       self.images_path = "/fsx/homes/Abdelrahman.Mohamed@mbzuai.ac.ae/abdo/BIO/FineCapEval/images"
 

       self.data = pd.read_csv("/fsx/homes/Abdelrahman.Mohamed@mbzuai.ac.ae/abdo/BIO/FineCapEval/FineCapEval.csv")
    #    breakpoint()
...
class DOCCI(Dataset):
    ...
    #    self.processor = AutoProcessor.from_pretrained("Salesforce/blip2-opt-2.7b")
       self.processor = AutoProcessor.from_pretrained("Salesforce/blip2-opt-2.7b-coco")
    #    self.hf = h5py.File(self.img_root, 'r')
       self.images_path = "/fsx/homes/Abdelrahman.Mohamed@mbzuai.ac.ae/abdo/Recaption/docci/images"
 

       self.data = pd.read_json("/fsx/homes/Abdelrahman.Mohamed@mbzuai.ac.ae/abdo/Recaption/docci/docci_descriptions.jsonlines", lines=True)
...
class DCI(Dataset):
    ...
    #    self.processor = AutoProcessor.from_pretrained("Salesforce/blip2-opt-2.7b")
       self.processor = AutoProcessor.from_pretrained("Salesforce/blip2-opt-2.7b-coco")
    #    self.hf = h5py.File(self.img_root, 'r')
       self.images_path = "/fsx/homes/Abdelrahman.Mohamed@mbzuai.ac.ae/abdo/Recaption/dci/densely_captioned_images/photos"
    ...
    #    self.data = pd.read_json("/fsx/homes/Abdelrahman.Mohamed@mbzuai.ac.ae/abdo/Recaption/dci/densely_captioned_images/splits.json")
