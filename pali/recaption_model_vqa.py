...
from transformers import AutoTokenizer, AutoModelForMaskedLM, AutoModel, AutoModelForVisualQuestionAnswering, AutoModelForPreTraining
...
class blip_recaption(Blip2ForConditionalGeneration):
    def __init__(self): 
        ...
        hug_token = "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"
